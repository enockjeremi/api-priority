...
export class Init1706397076336 implements MigrationInterface {
    name = 'Init1706397076336'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "workspaces" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "create_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "update_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer, CONSTRAINT "PK_098656ae401f3e1a4586f47fd8e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tasks" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "create_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "update_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "priority_id" integer, "status_id" integer, "workspacesId" integer, "user_id" integer, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "tasks" ADD CONSTRAINT "FK_d052c1e83f0167e96b47984dd3e" FOREIGN KEY ("workspacesId") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tasks" DROP CONSTRAINT "FK_d052c1e83f0167e96b47984dd3e"`);
        ...
        await queryRunner.query(`ALTER TABLE "workspaces" DROP CONSTRAINT "FK_78512d762073bf8cb3fc88714c1"`);
